...
def gera_pdf_mes(listatmp, mestmp, valorfinal):
    ...
    rpdf.cell(0, 0.6, 'Rua Coronel Paiva, 12  Centro  Ouro Fino MG', 0, 2, 'C')
    rpdf.line(1, 4.5, 20, 4.5)
    rpdf.set_font('Roboto', '', 11)
    rpdf.cell(0.5, 1, '', 0, 1)
    rpdf.cell(0.3, 1, '')
    # rpdf.cell(0.1, 0.6, str(''), 0, 0, 'L')
    rpdf.cell(2.4, 0.6, str('Data'), 0, 0, 'L')
    rpdf.cell(1.3, 0.6, str('Tipo'), 0, 0, 'L')
    rpdf.cell(6, 0.6, str('Categoria'), 0, 0, 'L')
    rpdf.cell(7.2, 0.6, str('Descrição'), 0, 0, 'L')
    ...
    rpdf.cell(3.9, 0.6, str('Valor final:'), 0, 0, 'L')
    rpdf.set_font('Roboto', 'B', 11)
